...
class ProcessRecipeSearch(View):
    ...
    def _percentage_of_ingredients_matched(self, query_params_ingredients):
        '''
        Private method to calculate the percentage of ingredient keywords matched for each Elasticsearch hit.
        ...
        def get_percentage_matched(recipe_ingredients):
            ...
            :param recipe_ingredients(str), from the request query
